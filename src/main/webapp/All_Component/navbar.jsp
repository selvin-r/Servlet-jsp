...
<div class="container-fluid p-3 " style="background-color: #eceff1">
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-success">
            ...
            <h1><i class="fa-solid fa-book-bible"></i>EBooks</h1>
        ...
        <div class="col-md-6">
            ...
            <form class="d-flex">
                <input class="form-control me-2 mt-2 w-50" type="search" placeholder="Search" aria-label="Search">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><i class="fa-regular fa-house"></i></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#" tabindex="-1" aria-disabled="true"><i class="fa-solid fa-book-skull"></i>Old Book</a>
                </li>
            </ul>
            <form class="d-flex">

                <button class="btn btn-light " type="submit"><i class="fa-solid fa-gear"></i>Setting</button>
                <button class="btn btn-light ms-1" type="submit"><i class="fa-solid fa-address-book"></i>Contact Us</button>
            </form>
        </div>
    </div>
</nav>